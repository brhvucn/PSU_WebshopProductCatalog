...
{
    internal class GetOrderQueryHandler : ICommandHandler<CreateOrderCommand>
    {
        private ILogger<CreateOrderCommandHandler> logger;
        private IOrderRepository orderRepository;

        public GetOrderQueryHandler(ILogger<CreateOrderCommandHandler> logger, IOrderRepository orderRepository)
        {
            this.logger = logger;
